...
<div class="input p-2 sm:px-20 bg-gray border-b border-r border-gray-200 bg-white  grid grid-cols-1">
    ...
    <div class=" -ml-4 text-lg text-gray-600 leading-none font-semibold">
        &nbsp;Sand flow rate(lb/d):
        <input type="string" style="border-width:1px" value="{{$w}}" disabled>
    </div>
    <div class=" -ml-4 text-lg text-gray-600 leading-none font-semibold">
        &nbsp;Velocity(ft/s):
        <input type="string" style="border-width:1px" value="{{$v}}" disabled>
    </div>
    <div class=" -ml-4 text-lg text-gray-600 leading-none font-semibold">
        &nbsp;Diameter(Inch):
        <input type="string" style="border-width:1px" value="{{$d}}" disabled>
    </div>
    <div class=" -ml-4 text-lg text-gray-600 leading-none font-semibold">
        &nbsp;Geometry::
    ...
    <div class="output border-b border-l border-gray-200 bg-white  grid grid-cols-1">
        <div class="bg-white  grid grid-cols-1 md:grid-cols-1">
            <div class="ml-4  text-lg text-gray-600 leading-none font-semibold">
                ...
                &nbsp;Erosion rate(mpy):
                <br> 
                <input type="string" style="border-width:1px" size="10" value="{{$er}}" disabled>
            </div>
