...
<form action="{{Route("calculators.storeapirp14e")}}" method="POST">

    @csrf
    <div class="p-2 sm:px-20 bg-gray border-b border-gray-200">
        <div class="mt-2 text-2xl">
            Welcome to your API RP 14E application!
        </div>
    ...
    <div class="bg-white grid grid-cols-1 md:grid-cols-4">
        ...
        <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l ml-4 text-lg text-gray-600 leading-7 font-semibold">
            <label>
                &nbsp;Oil flow(BOPD):
                <input type="number"  step="0.0001" name="i"  style="border-width:1px">
            </label>
        </div>
        <div class="p-6 border-t border-gray-200 ml-4 text-lg text-gray-600 leading-7 font-semibold">
            <label>
                &nbsp;Gas flow(MMSCFD):
                <input type="number"  step="0.00001" name="j"  style="border-width:1px">
            </label>
        </div>
        <div class="p-6 border-t border-gray-200 md:border-l ml-4 text-lg text-gray-600 leading-7 font-semibold">
            <label>
                &nbsp;Water flow(BWPD):
                <input type="number"  step="0.0001" name="k"  style="border-width:1px">
            </label>
        </div>
    </div>
    <div class="bg-white grid grid-cols-1 md:grid-cols-4">
        <div class="p-6 ml-4 text-lg text-gray-600 leading-7 font-semibold">
            <label>
                &nbsp;°API Oil:
                <input type="number"  step="0.01" name="l"  style="border-width:1px">
            </label>
        </div>
        <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l ml-4 text-lg text-gray-600 leading-7 font-semibold">
            <label>
    ...
    <div class=" grid grid-cols-1 md:grid-cols-4">
        <div class="bg-white p-6 ml-4 text-lg text-gray-600 leading-7 font-semibold">
            <label>
                &nbsp;Sand flow rate(bbl/month):
                <input type="number"  step="0.00001" name="sf"  style="border-width:1px">
            </label>
        </div>
        <div class="p-6 ml-4 text-lg text-gray-600 leading-7 font-semibold">
